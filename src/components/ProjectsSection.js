        ...
        <Fragment>
            ...
            <Grid container
                ...
                <Grid item xs={12} md={5}>
                    <ProjectCard title={"Workout Split Planner"} desc={"Interactive workout routine builder designed for optimizing and visualizing weekly volume and timing with over 1300 exercises from the  ExerciseDB API."} link={"https://exercise-planner.vercel.app/"} chips={["React", "API", "Material UI", "react-beautiful-dnd", "recharts"]} githubLink={"https://github.com/tjbarrett42/exercise-planner"} pic={require('../images/Demo2.png')}/>
                </Grid>
                <Grid item xs={12} md={5}>
